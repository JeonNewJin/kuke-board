...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(264704503989239808L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 264704503989239808L)
                .retrieve()
                .toBodilessEntity();
    }
    ...
    @Test
    void countTest() {
        ArticleResponse response = create(new ArticleCreateRequest("hi", "content", 1L, 10L));

        Long count1 = restClient.get()
                .uri("/v1/articles/boards/{boardId}/count", 10L)
                .retrieve()
                .body(Long.class);
